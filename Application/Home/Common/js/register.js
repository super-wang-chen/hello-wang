	...
	$('.agreement label').click(function(){
		...
		if(state){
			$(this).css('background','url("/Application/Home/Common/images/checked_box.jpg") no-repeat 0 3px');
		}else{
			$(this).css('background','url("/Application/Home/Common/images/check_box.jpg") no-repeat 0 3px');
		};
		console.log(state);
	});

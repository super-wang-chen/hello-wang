$(function(){
	$('input[type="checkbox"]').click(function(){
		...
		if(state){
			$(this).parent().css({
				'background':'url("/qmss/Application/Home/Common/images/checked_box.png") no-repeat',
				'background-position': '85px'
			});
		}else{
			$(this).parent().css({
				'background':'url("/qmss/Application/Home/Common/images/check_box.png") no-repeat',
				'background-position': '85px'
			});
		};
	});

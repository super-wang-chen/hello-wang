...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
              ...
              <a href="#" class="close"><img src="/qmss/Application/Admin/Common/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" />
              </a>
            ...
            <tbody>
              ...
              <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td><?php echo ($vo["pid"]); ?></td>                              
                <td>
                  <!-- Icons -->
                  <a href="/qmss/index.php/Admin/Product/product_cate_update?id=<?php echo ($vo["id"]); ?>" title="Edit">
                  <img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="/qmss/index.php/Admin/Product/product_cate_delete?id=<?php echo ($vo["id"]); ?>" title="Delete">

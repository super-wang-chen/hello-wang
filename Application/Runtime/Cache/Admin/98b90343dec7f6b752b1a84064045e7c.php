...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="/qmss/index.php/Admin/News/news_update" method="post" enctype="multipart/form-data" class="demoform" >
            <fieldset>
           
            <p>
              <label>标题</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="title" nullmsg="标题不能为空！" datatype="*" value="<?php echo ($data['title']); ?>" />
              <input  type="hidden"  name="id" value="<?php echo ($data['id']); ?>" />
              <input  type="hidden"  name="curpage" value="<?php echo ($curpage); ?>" />
            </p>
            <p>
              <label>作者</label>
              <input class="text-input small-input" type="text" id="small-input" name="author" nullmsg="作者不能为空！" datatype="*" value="<?php echo ($data['author']); ?>" />
           </p>

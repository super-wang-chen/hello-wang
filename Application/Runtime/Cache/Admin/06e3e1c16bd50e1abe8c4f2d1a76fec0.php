        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($vo["delivery"]); ?></td>
                  <!-- Icons -->
                <td>
                  <a href="/qmss/index.php/Admin/Order/order?id=<?php echo ($vo["id"]); ?>&curpage=<?php echo ($curpage); ?>&state=sended" title="Edit">
                  <img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="/qmss/index.php/Admin/Order/order_delete?id=<?php echo ($vo["id"]); ?>&curpage=<?php echo ($curpage); ?>&state=sended" title="Delete">
        ...
        success:function(msg){
          ...
          for(var i=0;i<msg.lists.length;i++){
              ...
              str+='<td>'+msg.lists[i]["delivery"]+'</td>';
               str+='<td>';
              str+='<a href="/qmss/index.php/Admin/Order/order?state=sended&id='+msg.lists[i]["id"]+'&curpage='+curpage+'" title="Edit">';
              str+='<img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a> ';
              str+='<a href="/qmss/index.php/Admin/Order/order_delete?state=sended&id='+msg.lists[i]["id"]+'&curpage='+curpage+'" title="Delete">';

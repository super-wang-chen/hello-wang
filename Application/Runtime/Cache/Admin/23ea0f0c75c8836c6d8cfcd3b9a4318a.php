...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <div class="clear"></div>
    <!-- End .clear -->
<script type="text/javascript" charset="utf-8" src="/qmss/Public/uedit/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/qmss/Public/uedit/ueditor.all.min.js"> </script>
<script type="text/javascript" charset="utf-8" src="/qmss/Public/uedit/lang/zh-cn/zh-cn.js"></script>
...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="/qmss/index.php/Admin/Single/contact_update" method="post" enctype="multipart/form-data" class="demoform" >
            <fieldset>
            <p>
              <label>网址</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="url" nullmsg="网址不能为空！" datatype="url"  errormsg="网址格式不正确" value="<?php echo ($data["url"]); ?>" />
            </p>
            <p>
              <label>电话</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="phone" nullmsg="电话不能为空！" datatype="*" value="<?php echo ($data["phone"]); ?>" />
            </p>
            <p>
              <label>QQ</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="qq" nullmsg="QQ不能为空！" datatype="n6-20" value="<?php echo ($data["qq"]); ?>" />
            </p>
            <p>
              <label>邮箱</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="email" nullmsg="邮箱不能为空！" datatype="e" errormsg="邮箱格式不正确" value="<?php echo ($data["email"]); ?>" />
            </p>
            <p>
              <label>地址</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="address" nullmsg="地址不能为空！" datatype="*" value="<?php echo ($data["address"]); ?>" />
            </p>
            <p>
              <label>官方微信二维码</label>
              <input type="file" name="official_image" class="official_image" />
              <img src="/qmss/<?php echo ($data["official_image"]); ?>" class="myimg1" style="height: 114px; width: 114px" />
            </p>
            <p>
              <label>客服微信二维码</label>
              <input type="file" name="service_image" class="service_image" />
              <img src="/qmss/<?php echo ($data["service_image"]); ?>" class="myimg2" style="height: 114px; width: 114px" />
            </p>
    ...
    $(".official_image").change(function(){
        ...
        if (window.FileReader) {    
          ...
          reader.onloadend = function (e) {
            $(".myimg1").attr("src",e.target.result);    //e.target.result就是最后的路径地址
            };   
       }
    })

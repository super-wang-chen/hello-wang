...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="/qmss/index.php/Admin/Single/brand_update" method="post" enctype="multipart/form-data" class="demoform" >
            <fieldset>
            <p>
              <label>图片</label>
              <input type="file" name="image" id="myfile" />
              <img src="/qmss/<?php echo ($data["image"]); ?>" class="myimg"  />
            </p>
            <p>
              <label>内容</label>

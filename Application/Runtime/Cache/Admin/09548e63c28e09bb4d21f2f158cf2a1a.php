...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="/qmss/index.php/Admin/Product/product_add" method="post" enctype="multipart/form-data" >
            <fieldset>
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
              <label>商品名称</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="pro_name" nullmsg="商品名称不能为空！" datatype="*" />
            </p>
            <p>
              <label>产品分类</label>
            ...
            <p>
              <label>商品原价</label>
              <input type="text" name="price" nullmsg="价格不能为空！" datatype="*" />
            </p>
            <p>
              <label>商品现价</label>
              <input type="text" name="new_price" nullmsg="价格不能为空！" datatype="*" />
            </p>
            <p>
              <label>商品库存</label>
              <input type="text" name="num" nullmsg="库存不能为空！" datatype="*" />
            </p>
            <div class="attr" style="margin: 20px 0;">
              <h5>商品属性</h5>(多个属性值用一个空格隔开)
              <p>
                <input type="text" name="key[]" placeholder="属性名称" />
                <input type="text" name="val[]" placeholder="属性值" />
            ...
            <p>
              <label>产品图片</label>
              <input type="file" name="image[]" id="myfile" multiple="multiple" nullmsg="请添加产品图片！" datatype="*" />
              <ul class="images">
              </ul>
              <style>

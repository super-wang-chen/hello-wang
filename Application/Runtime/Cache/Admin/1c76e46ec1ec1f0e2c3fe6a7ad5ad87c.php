          ...
          <table>
            ...
            <tbody>
              ...
              <?php if(is_array($banner)): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><img src="/qmss/<?php echo ($vo["image"]); ?>" style="height:100px;width: 400px"/></td>
                <td><?php echo ($vo['pro_name']['pro_name']); ?></td>
                <td>
                  <!-- Icons -->
                  <a href="/qmss/index.php/Admin/Single/banner_delete?id=<?php echo ($vo["id"]); ?>" title="Delete">

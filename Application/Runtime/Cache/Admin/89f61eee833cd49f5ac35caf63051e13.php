...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            用户：<?php echo ($members["user"]); ?><br/><br/>
            邮箱：<?php echo ($members["email"]); ?><br/><br/>
            电话：<?php echo ($members["phone"]); ?><br/><br/>
            经验：<?php echo ($members["exp"]); ?><br/><br/>
            VIP等级：<?php echo ($members["vip"]); ?><br/><br/>
            积分：<?php echo ($members["integral"]); ?><br/><br/>
            优惠卷：<?php echo ($members["coupons"]); ?><br/><br/><br/>
            <a href="/qmss/index.php/Admin/Members/lists?p=<?php echo ($curpage); ?>">返回</a>
          </table>
        </div>
        <!-- End #tab1 -->
      </div>

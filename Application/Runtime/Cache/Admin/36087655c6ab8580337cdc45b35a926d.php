        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="/qmss/index.php/Admin/News/news_update?id=<?php echo ($vo["id"]); ?>&curpage=<?php echo ($curpage); ?>" title="Edit">
                  <img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="/qmss/index.php/Admin/News/news_delete?id=<?php echo ($vo["id"]); ?>&curpage=<?php echo ($curpage); ?>" title="Delete">
      ...
      $.ajax({
        ...
        success:function(msg){
          ...
          for(var i=0;i<msg.lists.length;i++){
            ...
            str+='</td>';
            str+='<td>'+msg.lists[i]["title"]+'</td>';
            str+='<td>'+msg.lists[i]["author"]+'</td>';
            str+='<td>'+msg.lists[i]["create_time"]+'</td>';
            str+='<td><img src="/qmss/'+msg.lists[i]["image"]+'" style="height:100px;width: 100px"/></td>';
            str+='<td>';
            str+='<a href="/qmss/index.php/Admin/News/news_update?id='+msg.lists[i]["id"]+'&curpage='+curpage+'" title="Edit">';
            str+='<img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a>' ;
            str+='<a href="/qmss/index.php/Admin/News/news_delete?id='+msg.lists[i]["id"]+'&curpage='+curpage+'" title="Delete">';

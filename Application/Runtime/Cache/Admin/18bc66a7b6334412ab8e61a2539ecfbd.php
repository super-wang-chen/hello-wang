        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><input id="send" type="button" value="发货" rel="/qmss/index.php/Admin/Order/order_send?id=<?php echo ($vo["id"]); ?>"/></td>
                  <!-- Icons -->
                <td>
                  <a href="/qmss/index.php/Admin/Order/order?id=<?php echo ($vo["id"]); ?>&curpage=<?php echo ($curpage); ?>&state=index" title="Edit">
                  <img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="/qmss/index.php/Admin/Order/order_delete?id=<?php echo ($vo["id"]); ?>&curpage=<?php echo ($curpage); ?>" title="Delete">
      ...
      $.ajax({
        ...
        success:function(msg){
          ...
          for(var i=0;i<msg.lists.length;i++){
              ...
              str+='<td><input id="send" type="button" value="发货" rel="/qmss/index.php/Admin/Order/order_send?id='+msg.lists[i]["id"]+'"/></td>';
               str+='<td>';
              str+='<a href="/qmss/index.php/Admin/Order/order?state=index&id='+msg.lists[i]["id"]+'&curpage='+curpage+'" title="Edit">';
              str+='<img src="/qmss/Application/Admin/Common/resources/images/icons/pencil.png" alt="Edit" /></a> ';
              str+='<a href="/qmss/index.php/Admin/Order/order_delete?id='+msg.lists[i]["id"]+'&curpage='+curpage+'" title="Delete">';
    ...
    $.ajax({
      ...
      success:function(msg){
        if(msg==1){
          //alert(msg)
          alert('发货成功！');
          window.location.href="/qmss/index.php/Admin/Order/index?p=1";
        }else{
          //alert(msg)
          alert('发货失败！');
        }

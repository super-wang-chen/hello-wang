...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <p><b>商品信息</b></p>
          <p>名称：<span><?php echo ($order["pro_name"]); ?></span></p>
          <p>数量：<span><?php echo ($order["number"]); ?></span></p>
          <p>总价：<span>￥<?php echo ($order["price"]); ?></span></p>  
        ...
        <div>
          ...
          <p><b>配送信息</b></p>          
          <p>收货人：<span><?php echo ($order["name"]); ?></span></p>
          <p>收货地址：<span><?php echo ($order["address"]); ?></span></p>
          <p>手机号码：<span><?php echo ($order["phone"]); ?></span></p>
           
        </div>
       
        
      
            <a href="/qmss/index.php/Admin/Order/<?php echo ($state); ?>?p=<?php echo ($curpage); ?>">返回</a>
          </table>
        </div>
        <!-- End #tab1 -->
      </div>

...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="/qmss/index.php/Admin/Product/product_update" method="post" enctype="multipart/form-data" >
            <fieldset>
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
              <label>商品名称</label>
              <input class="text-input medium-input datepicker" type="text" id="medium-input" name="pro_name" value="<?php echo ($data['pro_name']); ?>"  />
            ...
            <p>
              ...
              <select name="cate" class="small-input">
                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["id"] == $data['cate']): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option>
            ...
            <p>
              <label>商品现价</label>
              <input type="text" name="new_price" value="<?php echo ($data['new_price']); ?>" />
            </p>
            <p>
              <label>商品库存</label>
            ...
            <div class="attr" style="margin: 20px 0;">
              <h5>商品属性</h5>
              <?php if(is_array($data['attr'])): foreach($data['attr'] as $k=>$v): ?><p>
                <input type="text" name="key[]" value="<?php echo ($k); ?>" />
                <input type="text" name="val[]" value="<?php echo (implode(' ',$v)); ?>" />
            ...
            <p>
              ...
              <ul class="images">
              <?php if(is_array($data['image'])): $i = 0; $__LIST__ = $data['image'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><li>
                  <img src="/qmss/<?php echo ($voo); ?>" />
            ...
            <p>
              <label>商品详情</label>
             <textarea id="editor" type="text/plain" name="content" style="height:300px;" nullmsg="内容不能为空！" datatype="*"><?php echo ($data['content']); ?></textarea>
            </p>
            <p>
